    ...
    <div className="flex flex-col min-h-screen bg-[#FFFAF5]">
      ...
      <main className="flex-1 container max-w-screen-lg px-4 py-8 md:px-6">
        ...
        <div className="flex items-center space-x-4 mb-8">
          ...
          <div>
            <h1 className="text-3xl font-bold tracking-tighter">Personal Challenge</h1>
            <p className="text-slate-600">Create a bet around a personal challenge between friends</p>
          </div>
        </div>
        ...
        <div className="bg-white rounded-xl p-8 shadow-sm border border-orange-100">
          <form className="space-y-6">
            <div className="space-y-2">
              ...
              <Input id="challenge-title" placeholder="e.g., 5K Run Challenge, Weight Loss Bet" />
            </div>
            ...
            <div className="space-y-2">
              ...
              <Textarea
                ...
                placeholder="Describe the challenge in detail, including how the winner will be determined"
            ...
            <div className="space-y-2">
              ...
              <Input id="evidence" placeholder="e.g., Photo proof, Strava activity, etc." />
            </div>
